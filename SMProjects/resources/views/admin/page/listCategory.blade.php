                ...
                <div class="panel panel-primary">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <br>
                            <a href="{{ route('admin.category.add') }}" class="btn btn-warning"><span
                                    class="glyphicon glyphicon-trash"></span>Add New Category</a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        @foreach ($category as $key => $value)
                                            <td style="font-size: 18px">
                                                {{ $value->category_name }}
                                                <br>
                                                <span style="font-size: 13px">Description:
                                                    {{ $value->category_description }}</span>
                                            </td>
                                            <td>
